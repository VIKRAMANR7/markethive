...
export const columns: ColumnDef<SubCategoryWithCategoryType>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <span className="font-extrabold text-lg capitalize">{row.original.category.name}</span>
      );
    },
  },
  {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            ...
            onClick={async () => {
              const updatedSubCategory = await getSubCategory(rowData.id);
              setOpen(
                <CustomModal>
                  <SubCategoryDetails
                    categories={categories}
                    data={updatedSubCategory || rowData}
                  />
                </CustomModal>
              );
            }}
